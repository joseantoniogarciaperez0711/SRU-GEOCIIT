...
<head>
  ...
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDATIjygC9qtZYXmSJRbYpdnHPkSCouo6g&callback=initMap"
    defer></script>
...
<body>
  ...
  <aside id="map-slider" class="map-slider">
    ...
    <a href="http://127.0.0.1:5500/html/seccion.html">
    ...
    <div class="slider-selectors">
      ...
      <div class="scroll">
        ...
        <div class="variables">
          <div>
            <h3 style="cursor: pointer;" title="
          Esta consideración se refiere a la cantidad del cultivo producido en un municipio, al añadir esta variable aseguras que, al establecerte, te establecerás en un municipio de donde suele salir la cantidad de producción del cultivo que te interesa. Con esto, tendremos la certeza de que tu producción se convertirá en una de las mayores en el mercado.
          ">Producción</h3>
          </div>
        ...
        <div class="variables">
          <div>
            <h3 style="padding-right: 55px; cursor: pointer;" title="
            Esta consideración se refiere a el tipo de suelo que existe sobre cada municipio, al añadir esta variable aseguras que, al establecerte, te establecerás en un municipio que tiene el suelo más favorable para tu cultivo. Con esto, tendremos la certeza de que tu producción estarás en las mejores manos (Las tuyas) y las mejores tierras.
          ">Suelo</h3>
          </div>
        ...
        <div class="variables">
          <div>
            <h3 style="padding-right: 5px; 55px; cursor: pointer;" title="
            Esta consideración se refiere al tipo de vegetación que existe sobre cada municipio, al añadir esta variable aseguras que, al establecerte, te establecerás en un municipio que tiene el tipo de vegetación más apto para tu cultivo. Con esto, tendremos la certeza de que tu producción crecerá en un ambiente favorable.
          ">Vegetación</h3>
          </div>
        ...
        <div class="variables">
          <div>
            <h3 style="padding-right: 53px; cursor: pointer;" title="
            Esta consideración se refiere al tipo de clima que existen dentro del municipio, al añadir esta variable aseguras que, al establecerte, te establecerás en un municipio que tiene el tipo de clima más favorable para tu cultivo. Con esto, tendremos la certeza de que tu producción crecerá en un clima favorable, y no tendrás problemas con ello.
          ">Clima</h3>
          </div>
        ...
        <div class="variables">
          <div>
            <h3 style="padding-right: 48px; cursor: pointer;" title="
            Esta consideración se refiere al nivel de lluvia mínimo y máximo que existe en el municipio, al añadir esta variable aseguras que, al establecerte, te establecerás en un municipio que tiene los niveles de lluvia más favorables para tu cultivo. Con esto, tendremos la certeza de que tu producción no sufrirá de sequías o inundaciones.
          ">Lluvia</h3>
          </div>
...
<script>
  ...
  function rangoLluvia() {
    ...
    return (lluvia * 100) / obtenerSumatoria();
  }
